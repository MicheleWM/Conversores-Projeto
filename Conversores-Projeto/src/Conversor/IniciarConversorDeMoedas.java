...
public class IniciarConversorDeMoedas {
	public void iniciar(String escolheMoedas, String tipoDeMoeda[]) {
		ConverterMoedas cm = new ConverterMoedas();
		String input = null;
		double valor;

		do {
			if (escolheMoedas == tipoDeMoeda[0]) {
				input = JOptionPane.showInputDialog(null, "Digite o valor em Reais(R$):");
				...
				input = JOptionPane.showInputDialog(null, "Digite o valor em Dólares(US$):");
				if (input.matches("(?:\\.|[0-9])*")) {
					valor = Double.parseDouble(input);
				...
				input = JOptionPane.showInputDialog(null, "Digite o valor em Euros(€):");
				if (input.matches("(?:\\.|[0-9])*")) {
					valor = Double.parseDouble(input);
				...
				input = JOptionPane.showInputDialog(null, "Digite o valor em Libras Esterlinas(£):");
				if (input.matches("(?:\\.|[0-9])*")) {
					valor = Double.parseDouble(input);
				...
				input = JOptionPane.showInputDialog(null, "Digite o valor em Peso Argentino($):");
				if (input.matches("(?:\\.|[0-9])*")) {
					valor = Double.parseDouble(input);
				...
				input = JOptionPane.showInputDialog(null, "Digite o valor em Peso Chileno($):");
				if (input.matches("(?:\\.|[0-9])*")) {
					valor = Double.parseDouble(input);
